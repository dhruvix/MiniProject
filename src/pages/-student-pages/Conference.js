...
const options={x:["conferenceType","departmentId","year"],
             y:["NoOfStu"],
...
const names={x:["type of conference","department","year"],
            y:["No. of students"],
            year:["all","2019","2018","2017","2016","2015"],
   ...
   return(       
      <div>
      {component?(<Options submithandler= {submithandler} options={options} names={names} table="student_conference_publications"/>):
          (type1==="data")?
