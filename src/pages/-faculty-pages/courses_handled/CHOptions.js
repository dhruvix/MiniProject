...
function CHOptions({submithandler})
{
  const [yvalue, sety] = useState(true);
  let obj
  if(!yvalue)
  obj={tab:"courses_handled",x:"departmentId",y:"No of Cou",dep:"all"} 
  else
  obj={tab:"courses_handled",x:"typeOfSubject",y:"No of Fac",dep:"all"}
  const [hstudies, setIt] = useState(obj);
  
  function handle(event){
    event.persist()
        if(event.target.value==="dep"){
          sety(false);
          obj={tab:"courses_handled",x:"departmentId",y:"No of Cou",dep:"all"}
          setIt(obj)
        }
          ...
          <form >
            <div>
              ...
              <div className="together">
                ...
                <option value="typeOfSubject">type of subject</option>
              ...
              <div className="together">
                ...
                <select className="select-css" id="y" name="y" onChange={handleChange} >
                  <option value="No of Cou">no. of courses</option>
                </select>
              </div>
              :
              <div className="together">
