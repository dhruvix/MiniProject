...
function FacOptions({submithandler})
{
  const [yvalue, sety] = useState(true);
  let obj
  if(!yvalue)
  obj={tab:"faculty",x:"departmentId",y:"pay",dep:"all"} 
  else
  obj={tab:"faculty",x:"gender",y:"No of Fac",dep:"all"}
            ...
            <div>
              ...
              <div className="together">
                ...
                <select className="select-css" id="x" name="x" onChange={handleChange} onClick={handle}>
                  ...
                  <option value="natureOfAppointment">nature of appointment</option>
              ...
              {!yvalue?
                ...
                <option value="pay">avg. pay scale basic</option>
                </select>
              </div>
              :
              <div>
