...
const options={x:["registrationYear","yearOfCompletion","status","university","centreName"],
            y:["nof"],
            year:["all","2019","2018","2017","2016","2015"]
            };

const names={x:["registration year","year of completion","status","university","centre name"],
   ...
   return(       
      <div>
      {component?(<Options submithandler= {submithandler} options={options} names={names} table="faculty_research"/>):
          (type1==="data")?
